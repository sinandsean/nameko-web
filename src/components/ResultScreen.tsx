...
import { Share2, RefreshCw, Flame, Zap } from 'lucide-react';
...
export function ResultScreen({ capturedPhoto, generatedName, onTryAgain, onShare }: ResultScreenProps) {
    ...
    >
      ...
      <div className="relative z-10 p-6 pb-12">
        ...
        >
          ...
          >
            <Flame className="w-16 h-16 text-yellow-400" fill="currentColor" strokeWidth={0} />
          </motion.div>
        </motion.div>
        ...
        >
          <div className="relative">
            ...
            <div className="relative w-28 h-28 rounded-3xl overflow-hidden border-4 border-yellow-400 shadow-2xl rotate-3">
              <img src={capturedPhoto} alt="Your photo" className="w-full h-full object-cover -rotate-3" />
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-white/80 mb-4" style={{ fontSize: '1.75rem', fontWeight: '700' }}>
        ...
        >
          <div className="bg-white/5 backdrop-blur-md rounded-3xl p-6 border-2 border-white/10">
            <p className="text-white/90 text-center leading-relaxed" style={{ fontSize: '1.125rem', fontWeight: '600' }}>
        ...
        >
          <h3 className="text-white/80 mb-5 text-center" style={{ fontSize: '1.125rem', fontWeight: '700' }}>
            why this name tho? 🤔
          </h3>
          ...
          <div className="space-y-3">
            {generatedName.reasons.map((reason, index) => (
              ...
              >
                ...
                <p className="text-white/80 flex-1" style={{ fontWeight: '500' }}>
                  {reason}
                </p>
              </motion.div>
            ))}
        ...
        >
          ...
          >
            <span className="relative z-10 flex items-center gap-3" style={{ fontSize: '1.125rem', fontWeight: '900' }}>
